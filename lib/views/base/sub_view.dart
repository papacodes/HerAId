...
import 'package:mzala/helpers/animation_helper.dart';
import 'package:mzala/viewmodels/base/sub_viewmodel.dart';
import 'package:mzala/views/base/base_view.dart';
import 'package:mzala/views/burger_menu/burger_menu_view.dart';
import 'package:app_theme/app_theme.dart';
import 'package:app_theme/presentation/widgets/app_bars/back_nav_bar.dart';
import 'package:app_theme/presentation/widgets/generic/hide_on_keyboard_open.dart';
...
class _SubViewState extends State<SubView> {
  ...
  Widget build(BuildContext context) {
    ...
    var navBar = BackNavBar.fromTheme(
      key: Key('SubViewFlowKeys.navBarKey'),
        ...
        child: Container(
          ...
          child: RawScrollbar(
            ...
            child: SingleChildScrollView(
              key: Key('SubViewFlowKeys.scrollView'),
              controller: _scrollController,
              child: Column(
  ...
  Widget _doneFooterSection({required ThemeProvider theme}) {
    var doneButton = Button.fromTheme(
      key: Key('SubViewFlowKeys.doneButtonKey'),
